...
class MusicRetrievalDemo:
    ...
    def file_search_demo(self):
        ...
        # 显示可用的测试文件
        test_files = [
            "/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/MI_retrieve/retrieve_libraries/segments_1min/32_1min_01.mp4",
            "/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/MI_retrieve/retrieve_libraries/segments_1min/56_1min_03.mp4",
            "/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/MI_retrieve/retrieve_libraries/segments_3min/32_3min_02.mp4",
            "/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/MI_retrieve/retrieve_libraries/segments_3min/56_3min_05.mp4"
        ]
    ...
    def _simulate_description_search(self, description: str, duration: str, search_count: int) -> dict:
        ...
        for video_name in selected_videos:
            video_path = f"/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/MI_retrieve/retrieve_libraries/segments_{duration}/{video_name}.mp4"
            results.append({
