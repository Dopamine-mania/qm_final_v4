...
def test_single_extraction():
    """测试单个视频的特征提取"""
    # 路径配置
    video_path = "/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/MI_retrieve/materials/retrieve_libraries/segments_1min/32_1min_01.mp4"
