...
class MusicSearchSystem:
    ...
    def __init__(self, features_base_dir: str = None):
        ...
        if features_base_dir is None:
            features_base_dir = "/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/materials/music_features"
    ...
    def get_video_path(self, video_name: str, duration: str) -> Optional[str]:
        ...
        Returns:
            视频文件路径或None
        """
        video_dir = f"/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/materials/retrieve_libraries/segments_{duration}"
...
def main():
    ...
    # 示例：使用现有的一个音乐文件作为查询
    # 这里可以替换为实际的音频文件路径
    sample_video = "/Users/wanxinchen/Study/AI/Project/Final project/SuperClaude/qm_final4/materials/retrieve_libraries/segments_1min/32_1min_01.mp4"
